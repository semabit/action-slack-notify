...
LABEL "org.opencontainers.image.source"="https://github.com/semabit/action-slack-notify"

WORKDIR ${GOPATH}/src/github.com/semabit/action-slack-notify
COPY main.go ${GOPATH}/src/github.com/semabit/action-slack-notify
